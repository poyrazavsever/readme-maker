    ...
    return (
        <div className='w-full flex items-center justify-between container mx-auto py-4 transition-all'>
            ...
            <ul className='flex items-center justify-center gap-6'>
                ...
                <li><a href="/" className={linkStyle}>MD & Readme</a></li>
            ...
            <div className='flex items-center justify-center gap-6'>
                ...
                <div className='relative group'>
                    <a href="https://github.com/poyrazavsever?tab=repositories" target='__blank' className='hover:text-neutral-600 transition-all'>
