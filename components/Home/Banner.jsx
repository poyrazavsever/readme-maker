  ...
  return (
    <div className='flex mobile:w-full flex-col items-start justify-between gap-12 mt-16 desktop:mt-36 desktop:flex-row p-5 md:p-0'>
      ...
      <div className='flex flex-col items-start mobile:justify-center gap-6 md:w-1/2'>
        ...
        <p className='text-sm sm:text-base font-medium tracking-wider'>Use our Markdown editor and GitHub integrations to quickly and aesthetically create your <span className='font-bold tracking-widest'>README files</span>. Professional look and usability in just a few clicks!</p>
