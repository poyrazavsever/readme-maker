...
function Footer() {
    ...
    const socialStyle = "text-tert hover:text-secondary transition text-xl"

    return (
        <div className='flex flex-col items-center justify-center gap-4 py-8'>
            <h3 className='text-sm sm:text-base text-fourth font-bold tracking-wider'>My Social Media</h3>
            ...
            <p className='text-xs text-fourth font-medium'>This site was designed and coded by Poyraz Avsever</p>
        </div>
    )
}
